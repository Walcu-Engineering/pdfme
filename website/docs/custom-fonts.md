...
You can import from `@walcu-engineering/pdfme-common` as below.

```ts
import type { Font } from '@walcu-engineering/pdfme-common';
```
...
```ts
import { Template, BLANK_PDF, Font } from '@walcu-engineering/pdfme-common';
